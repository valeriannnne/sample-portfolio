    ...
    <div className='container mx-auto'>
      <div className='flex flex-col lg:flex-row'>
        ...
        className='flex-1 border rounded-2xl p-6 pb-16 lg:pb-20 gap-y-6 flex flex-col items-start'>
          ...
          <textarea className='lg:mb-10 mb-8 bg-transparent border-b py-3 outline-none w-full placeholder:text-white focus:border-accent transition-all resize-none' 
          name='' id='' cols={30} rows={6} placeholder='Your Message'/>
